import { getConsultationById, deleteConsultationFile } from "../../database/consultation.js";
...
export const deleteConsultationFileController = async (req, res) => {
  ...
  const filePath = path.join(PUBLIC_DIR, 'consultationFiles', user.id.toString(), fileName);
  ...
  if (result.affectedRows > 0) {
    ...
    throw generateErrors(500, 'SERVER_ERROR', 'Error al eliminar el archivo de la base de datos');
  }
};